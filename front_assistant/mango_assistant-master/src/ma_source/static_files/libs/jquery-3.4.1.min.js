if (!window.jQuery) {
  console.log("MA: jquery еще не загружен!");
            ...
            ? ("none" === n && ((l[c] = Q.get(r, "display") || null), l[c] || (r.style.display = "")),
              "" === r.style.display &&
                ...
                (l[c] =
                  ...
                  (s = i.nodeName),
                  (u = ce[s]) ||
                    ((o = a.body.appendChild(a.createElement(s))), (u = k.css(o, "display")), o.parentNode.removeChild(o), "none" === u && (u = "block"), (ce[s] = u)))))
    ...
    function dt(o, e, t) {
      ...
      for (
        !(function (e, t) {
          ...
          for (n in e)
            if (
              ((i = t[(r = V(n))]), (o = e[n]), Array.isArray(o) && ((i = o[1]), (o = e[n] = o[0])), n !== r && ((e[r] = o), delete e[n]), (a = k.cssHooks[r]) && ("expand" in a))
            )
  ...
  console.log("MA: jquery 3.4.1 загружен!");
} else {
  console.log("MA: jquery уже загружен!");
}
